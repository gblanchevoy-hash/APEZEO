  ...
  return (
    <div className="pb-10">
      ...
      {fichesDisponibles.length > 0 && (
        <div className="sticky top-0 z-20 mx-4 mt-3 lg:mx-8 px-5 py-3 bg-emerald-950/95 backdrop-blur text-white rounded-2xl shadow-lg flex items-center justify-between">
          <span className="text-emerald-100 text-sm">
            Fiches correspondantes
            <span className="block text-[11px] text-emerald-300">
              {q.typeVoulu === "tous" ? "tous types confondus" : q.typeVoulu === "concept" ? "fiches explicatives uniquement" : "techniques uniquement"}
            </span>
          </span>
