...
import {
  ...
  LayoutGrid, Activity, Frown, Footprints, ShieldAlert, Volume2, Moon,
  XCircle, Utensils, Compass, PenLine,
} from "lucide-react";
      ...
      <div className="py-20 text-center" style={{ background: "linear-gradient(135deg, #022c22, #064e3b)" }}>
        ...
        <div className="grid grid-cols-2 gap-4 max-w-[620px] mx-auto px-12">
          <button onClick={() => onChoose("aidant")} className="text-left bg-white/[0.08] border border-white/15 rounded-2xl p-6 hover:bg-white/[0.12] transition">
            ...
            <div className="inline-block text-xs font-bold bg-white text-emerald-950 rounded-lg px-4 py-2.5">Entrer dans l'espace aidants</div>
          </button>
          <button onClick={() => onChoose("pro")} className="text-left bg-white rounded-2xl p-6">
            ...
            <div className="inline-block text-xs font-bold bg-emerald-900 text-white rounded-lg px-4 py-2.5">Entrer dans l'espace professionnels</div>
          </button>
        </div>
      </div>

      <footer className="py-7 text-center text-xs text-stone-400">Mentions légales · Politique de confidentialité · Contact · © 2026 Apézeo, informations non médicales</footer>
    </div>
  );
}
