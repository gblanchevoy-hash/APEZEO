  ...
  return (
    ...
    <div className="w-full md:max-w-2xl md:bg-[#F4F6F2] md:rounded-3xl md:shadow-2xl md:overflow-hidden md:border md:border-stone-300/60 lg:max-w-none lg:rounded-none lg:shadow-none lg:border-none lg:overflow-visible">
      ...
      {current.view === "recommandations" && (
        <RecommandationsView title={current.trouble} results={current.results} suggestions={current.suggestions} favoris={{ liked: favoris, disliked: [] }} onBack={pop} onOpenFiche={(f) => push({ view: "fiche", fiche: f, rechercheLabel: current.trouble })} />
      )}
      {current.view === "fiche" && (
        <FicheDetailView
