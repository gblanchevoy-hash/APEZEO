...
export const SITUATIONS_TYPES = [
  ...
  { id: "agitation-soir", titre: "Agitation en fin de journée", contexte: "L'agitation ou la désorientation augmentent en fin d'après-midi ou en soirée.", troubles: ["Syndrome crépusculaire", "Agitation"] },
