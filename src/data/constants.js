...
export const SITUATIONS_TYPES = [
  { id: "toilette-refus", titre: "Refus de toilette le matin", contexte: "La personne s'oppose ou se ferme dès qu'on évoque la toilette.", troubles: ["Troubles pendant la toilette"], prioriser: ["EXP-131","EXP-132","EXP-133","EXP-134","EXP-135","EXP-136","EXP-137"] },
  ...
  { id: "agitation-soir", titre: "Agitation en fin de journée", contexte: "L'agitation ou la désorientation augmentent en fin d'après-midi ou en soirée.", troubles: ["Syndrome crépusculaire", "Agitation"], moment: "Soir" },
  ...
  { id: "reveils-nuit", titre: "Réveils répétés la nuit", contexte: "La personne se réveille plusieurs fois pendant la nuit.", troubles: ["Troubles nocturnes", "Sommeil perturbé"], moment: "Nuit" },
  { id: "deambulation-nocturne", titre: "Déambulations nocturnes dans les couloirs", contexte: "La personne marche dans les couloirs pendant la nuit.", troubles: ["Déambulation", "Troubles nocturnes"], moment: "Nuit", exclure: ["Participer à l'arrosage de quelques plantes", "Participer au ramassage de quelques feuilles dans un espace extérieur"] },
  ...
  { id: "retrait-tristesse", titre: "Personne triste, en retrait, qui ne fait plus rien", contexte: "La personne se retire, ne participe plus aux activités habituelles.", troubles: ["Symptômes dépressifs", "Apathie"], prioriser: ["EXP-127","EXP-128","EXP-129","EXP-130"] },
  { id: "confusion-lieu-temps", titre: "Désorientation sur le lieu ou le moment", contexte: "La personne ne sait plus où elle se trouve ou quel moment de la journée c'est (désorientation habituelle liée aux troubles neurocognitifs — à distinguer d'une confusion aiguë, urgence médicale).", troubles: ["Désorientation"] },
  ...
  { id: "arrivee-recente", titre: "Arrivée récente en structure, période d'adaptation difficile", contexte: "Une entrée récente en structure s'accompagne d'une période d'adaptation difficile.", troubles: ["Anxiété", "Opposition"], prioriser: ["EXP-138","EXP-139","EXP-140","EXP-141","EXP-142","EXP-143"] },
  ...
  { id: "question-boucle", titre: "Répéter sans arrêt la même question", contexte: "Une même question revient en boucle, quelle que soit la réponse donnée.", troubles: ["Répétitions verbales"], prioriser: ["EXP-121","EXP-122","EXP-123","EXP-124","EXP-125","EXP-126"] },
